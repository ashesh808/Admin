        ...
        <ul class="nav" id="side-menu">
            ...
            <li>
                ...
                <ul class="nav nav-second-level">
                    <li>
                        <a href="<?php echo base_url();?>flot">Flot Charts</a>
                    </li>
                    <li>
                        <a href="<?php echo base_url();?>morris">Morris.js Charts</a>
                    </li>
                </ul>
                <!-- /.nav-second-level -->
            </li>
            <li>
                <a href="<?php echo base_url();?>tables"><i class="fa fa-table fa-fw"></i> Tables</a>
            </li>
            <li>
                <a href="<?php echo base_url();?>forms"><i class="fa fa-edit fa-fw"></i> Forms</a>
            </li>
            <li>
